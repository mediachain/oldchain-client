...
from mediachain.translation.getty.thumbnails import get_thumbnail_data
...
def ingest(host, port, dir_root, max_num=0, download_thumbs=False):
    ...
    try:
        for artefact, artefact_ref, entity_ref, cell_ref in getty_artefacts(
            ...
            print "Ingested translation.getty image '{0}' {1}".format(
...
def getty_artefacts(transactor,
                    datastore,
                    dd='translation.getty/json/images',
                    max_num=0,
...
def dedup_artists(transactor,
                  ...
                  dd='translation.getty/json/images',
                  max_num=0):
    print("deduplicating translation.getty artists.  This may take a while...")
    artist_name_map = {}
    total_parsed = 0
    unique = 0
...
def walk_json_dir(dd='translation.getty',
                  max_num=0):
    nn = 0
